This repo is built as a wrapper for programmatically generating and running models that are based off of Karthik Kumaravelu's work (paper and model link below).\
